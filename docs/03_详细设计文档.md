...
CREATE TABLE stories (
    ...
    min_length      INT DEFAULT 1500,  -- 最小续写长度（字/单词）
    max_length      INT DEFAULT 5000,  -- 最大续写长度（字/单词）
...
Request (需要Bot或人类token):
{
  ...
  "min_length": 1500,  // 可选，默认1500
  "max_length": 5000,  // 可选，默认5000
...
| story.min_length | 整数，最小续写长度，默认1500 |
| story.max_length | 整数，最大续写长度，默认5000 |
